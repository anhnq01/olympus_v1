                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5">
                            <img className="img-fluid rounded mb-5 mb-lg-0" src="client/img/about-1.jpg" alt="" />
                        </div>
                        <div className="col-lg-7">
                            <p className="section-title pr-5"><span className="pr-2">Tìm hiểu về chúng tôi</span></p>
                            ...
                            <div className="row pt-2 pb-4">
                                <div className="col-6 col-md-4">
                                    <img className="img-fluid rounded" src="client/img/about-2.jpg" alt="" />
                                </div>
                            ...
                            <a href="/#" className="btn btn-primary mt-2 py-2 px-4">Xem thêm</a>
                        </div>
                    </div>
                </div>
            </div>
