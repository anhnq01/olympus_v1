            ...
            <div>
                ...
                <div className="container-fluid bg-primary mb-5">
                    <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '400px' }}>
                        <h3 className="display-3 font-weight-bold text-white">Chi tiết</h3>
                    ...
                    <div className="row pt-5">
                        <div className="col-lg-8">
                            <div className="d-flex flex-column text-left mb-3">
                                ...
                                <div className="d-flex">
                                    ...
                                    <p className="mr-3"><i className="fa fa-folder text-primary" /> Web Design</p>
                                    <p className="mr-3"><i className="fa fa-comments text-primary" /> 15</p>
                                </div>
                            </div>
                            <div className="mb-5">
                                <img className="img-fluid rounded w-100 mb-4" src={"client/img/blog-1.jpg"} alt="anh-1" />
                                ...
                                <img className="img-fluid rounded w-50 float-left mr-4 mb-3" src="client/img/blog-1.jpg" alt="anh-1" />
                                ...
                                <img className="img-fluid rounded w-50 float-right ml-4 mb-3" src="client/img/blog-2.jpg" alt="anh-1" />
                            ...
                            <div className="mb-5 mx-n3">
                                ...
                                <div className="owl-carousel post-carousel position-relative">
                                    <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                                        <img className="img-fluid" src="client/img/post-1.jpg" style={{ width: '80px', height: '80px' }} alt="anh" />
                                        <div className="pl-3">
                                    ...
                                    <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                                        <img className="img-fluid" src="client/img/post-2.jpg" style={{ width: '80px', height: '80px' }} alt="anh" />
                                        <div className="pl-3">
                                            <h5 className>Diam amet eos at no eos</h5>
                                            <div className="d-flex">
                                                <small className="mr-3"><i className="fa fa-user text-primary" /> Admin</small>
                                    ...
                                    <div className="d-flex align-items-center bg-light shadow-sm rounded overflow-hidden mx-3">
                                        <img className="img-fluid" src="client/img/post-3.jpg" style={{ width: '80px', height: '80px' }} alt="anh" />
                                        <div className="pl-3">
                                            <h5 className>Diam amet eos at no eos</h5>
                                            <div className="d-flex">
                                                <small className="mr-3"><i className="fa fa-user text-primary" /> Admin</small>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="media mb-4">
                                    <img src="client/img/user.jpg" alt="anh-1" className="img-fluid rounded-circle mr-3 mt-1" style={{ width: '45px' }} />
                        ...
                        <div className="col-lg-4 mt-5 mt-lg-0">
                            ...
                            <div className="d-flex flex-column text-center bg-primary rounded mb-5 py-5 px-4">
                                <img src="client/img/user.jpg" className="img-fluid rounded-circle mx-auto mb-3" style={{ width: '100px' }} alt="anh" />
                            ...
                            {/* Single Image */}
                            <div className="mb-5">
                                <img src="client/img/blog-1.jpg" alt="anh-2" className="img-fluid rounded" />
                            </div>
                            {/* Recent Post */}
                            <div className="mb-5">
                            ...
                            {/* Single Image */}
                            <div className="mb-5">
                                <img src="client/img/blog-2.jpg" alt="anh-2" className="img-fluid rounded" />
                            </div>
                            {/* Tag Cloud */}
                            <div className="mb-5">
                            ...
                            {/* Single Image */}
                            <div className="mb-5">
                                <img src="client/img/blog-3.jpg" alt="anh-2" className="img-fluid rounded" />
                            </div>
                            {/* Plain Text */}
                            <div>
